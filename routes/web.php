...
Route::get('attendance/student/show', [StudentAttendanceController::class, 'AttendanceShow'])->name('student.attendance.show');

Route::get('/attendance/student/add', [StudentAttendanceController::class, 'AttendanceAdd'])->name('student.attendance.add.classwise.get');

Route::get('/attendance/student/add1', [StudentAttendanceController::class, 'AttendanceAdd1'])->name('student.attendance.add1.classwise.get');

Route::post('attendance/student/store', [StudentAttendanceController::class, 'StudentAttendanceStore'])->name('store.student.attendance');

Route::post('attendance/student/update', [StudentAttendanceController::class, 'StudentAttendanceUpdate'])->name('update.student.attendance');

Route::get('attendance/student/edit/{date}', [StudentAttendanceController::class, 'AttendanceEdit1'])->name('student.attendance.edit');
