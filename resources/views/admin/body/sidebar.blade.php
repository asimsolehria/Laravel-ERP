...
<li class="treeview {{ ($prefix == '/setups')?'active':'' }}">
		...
		<li class="{{ ($route == 'student.attendance.show')?'active':'' }}"><a href="{{ route('student.attendance.show') }}"><i class="ti-more"></i>Attendance</a></li>
...
<li class="treeview {{ ($prefix == '/accounts')?'active':'' }}">
	...
	<ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview {{ ($prefix == '/profile')?'active':'' }}">
          <a href="#">
            <i data-feather="grid"></i> <span>{{Auth::user()->name}} Managment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		...
		<li><a>______________________</a></li>
		
		<li class="{{ ($route == 'student.attendance.show')?'active':'' }}"><a href="{{ route('student.attendance.show') }}"><i class="ti-more"></i>Attendance</a></li>
		
        <li class="{{ ($route == 'roll.generate.view')?'active':'' }}"><a href="{{ route('roll.generate.view') }}"><i class="ti-more"></i>Generate Roll No</a></li>
		<li class="{{ ($route == 'marks.entry.add')?'active':'' }}"><a href="{{ route('marks.entry.add') }}"><i class="ti-more"></i>Marks Entry</a></li>
